...
var html_url_prefix = "/hotg";
var CONFIGURED_HTML_URL_PREFIX = "/hotg";
var CONFIG_ONLY_SHOW_FOR_MULTIPLE_HEADERS = 0;
...
var gzip_hash = '14387895066435956894615998342514464051'                       // used to check whether the localStorage data is stale
...
function get_html_url_prefix(){
    return '/hotg'  // this value is replaced by the actual url prefix when compiled
}
